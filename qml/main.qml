...
Item {
    ...
    Rectangle {
        ...
        property var borderColor: root.compositing ? LongUI.Theme.darkMode ? Qt.rgba(255, 255, 255, 0.3)
                                                                           : Qt.rgba(0, 0, 0, 0.2) : LongUI.Theme.darkMode ? Qt.rgba(255, 255, 255, 0.15)
                                                                                                                           : Qt.rgba(0, 0, 0, 0.15)

        anchors.fill: parent
        radius: root.compositing && Settings.style === 0 ? windowRadius : 0
        color: LongUI.Theme.darkMode ? "#666666" : "#E6E6E6"
        // opacity: root.compositing ? LongUI.Theme.darkMode ? 0.5 : 0.5 : 0.9
        opacity: 0.8
    ...
    GridLayout {
        ...
        DockItem {
            ...
            Rectangle {
                anchors.fill: parent
                anchors.margins: LongUI.Units.smallSpacing / 2
                color: "transparent"
                border.color: LongUI.Theme.textColor
                radius: height * 0.3
                border.width: 1 / LongUI.Units.devicePixelRatio
                border.pixelAligned: LongUI.Units.devicePixelRatio > 1 ? false : true
