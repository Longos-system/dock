...
{
    QSettings settings(QSettings::UserScope, "longos", "dock_pinned");
    QSettings systemSettings("/etc/long-dock-list.conf", QSettings::IniFormat);
    ...
    // Launcher
    ApplicationItem *item = new ApplicationItem;
    item->id = "long-launcher";
    item->exec = "long-launcher";
